            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <div class="idea-tab-menu">
                    <ul class="nav idea-tab" role="tablist">
                        ...
                        <li role="presentation"><a href="#ideas" aria-controls="ideas" role="tab" data-toggle="tab">Địa chỉ giao hàng</a></li>
                        <li role="presentation"><a href="#design" aria-controls="design" role="tab" data-toggle="tab">Chi tiết thanh toán</a></li>
                        <li role="presentation"><a href="#devlopment" aria-controls="devlopment" role="tab" data-toggle="tab">Dơn hàng của tôi</a></li>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="creativity">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="input-box mb-20">
                                    ...
                                    <input type="text" name="namm" value="{{$user->name}}" class="info" placeholder="Tên">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-box mb-20">
                                    ...
                                    <input type="email" name="email" value="{{$user->email}}" class="info" placeholder="Email của bạn">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-box mb-20">
                                    <label>Số điện thoại<em>*</em></label>
                                    <input type="text" name="phone" value="{{$user->phone}}" class="info" placeholder="Số điện thoại">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-box mb-20">
                                    ...
                                    <select class="selectpicker select-custom" data-live-search="true">
                                        <option data-tokens="Bangladesh">Việt Nam</option>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-box mb-20">
                                    ...
                                    <input type="text" name="add1" class="info" placeholder="Thành phố">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-box mb-20">
                                    ...
                                    <select class="selectpicker select-custom" data-live-search="true">
                                        <option data-tokens="Barisal">Quận Gò Vấp</option>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="input-box mb-20">
                                    ...
                                    <input type="text" name="add1" value="{{$user->address}}" class="info mb-10" placeholder="Ngõ, đường...">
                                </div>
                            </div>
                            <div class=" col-md-6 col-sm-8 col-xs-12">
                                <div class="checkbox checkbox-2">
                                    <label> <small>
                                            <input name="signup" type="checkbox">Tôi muốn đăng ký nhận thông báo.
                                        </small> </label>
                                    <br>
                                    <label> <small>
                                            <input name="signup" type="checkbox">Tôi đã đọc và đồng ý với <a href="#">Chính sách quyền riêng tư</a>
                                        </small> </label>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-4 col-xs-12 text-right">
                                <a class="btn-def btn2" href="#">Lưu</a>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                <a class="btn-def btn2" href="#">Xóa tài khoản</a>
                            </div>
                        </div>
