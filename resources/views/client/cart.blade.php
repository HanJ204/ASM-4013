                                        ...
                                        <div class="table-responsive mb-20">
                                            <table class="shop_table-2 cart table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="cart_item">
                                                        <td class="item-img">
                                                            <a href="{{ url('/detail', [$cart['id']]) }}"><img src="/client/images/product/{{$cart['image']}}" alt=""> </a>
                                                        </td>
                                                        <td class="item-title"> <a href="#"> {{$cart['name']}} </a></td>
                                                        <td class="item-price"> {{ number_format($cart['priceSale'], 0, ',', '.') }}đ </td>
                                                        <td class="item-qty">
                                                                ...
                                                                <div class="product-qty">
                                                                    <div class="cart-quantity">
                                                                        <div class="cart-plus-minus">
                                                                            ...
                                                                            <input value="{{$cart['quantity']}}" name="qtybutton" class="cart-plus-minus-box" type="text">
                                                        ...
                                                        <td class="total-price"><strong> {{ number_format($cart['into_money'], 0, ',', '.') }}đ</strong></td>
                                                        <td class="remove-item"><a href="/deletecart/{{$cart['id']}}"><i class="fa fa-trash-o"></i></a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                                ...
                                                <div class="col-md-8 col-sm-7 col-xs-12">
                                                    <div class="update-coupne-area">
                                                        ...
                                                        <div class="coupn-area">
                                                            ...
                                                            <a href="#" class="btn-def btn2">Nhập mã</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-5 col-xs-12">
                                                    <div class="cart-total-area">
                                                        ...
                                                        <div class="sub-shipping">
                                                            <p>Tổng phụ <span>{{ number_format($total_amount, 0, ',', '.') }}VNĐ</span></p>
                                                            <p>Phí vận chuyển <span>30.000VNĐ</span></p>
                                                        </div>
                                                        ...
                                                        <div class="process-cart-total">
                                                            <p>Tổng tiền <span>{{ number_format($total_amount + 30000, 0, ',', '.') }}VNĐ</span></p>
                                                        </div>
