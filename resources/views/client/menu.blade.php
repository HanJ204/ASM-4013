    ...
    <div class="full-width-mega-dropdown">
      <div class="row">
        ...
        <div class="col-md-7 col-sm-10 hidden-xs">
          <nav id="primary-menu">
            <ul class="main-menu">
              <li class="current"><a class="active" href="{{ url('/') }}">Trang chủ</a>
              </li>
              <li class="mega-parent pos-rltv"><a href="{{ route('products') }}">Sản phẩm</a>
                <div class="mega-menu-area mma-800">
                  ...
                  <div class="mega-banner-img">
                    <a href="single-product.html"><img src="/client/images/banner/banner-fashion-02.jpg" alt=""></a>
                  </div>
                </div>
              </li>
